      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border border-blue-100 p-6">
        ...
        <div className="bg-blue-100 rounded-xl p-4 mb-6 relative">
          ...
          <button 
            ...
            className="absolute right-4 top-4 text-blue-600 hover:text-blue-800 text-sm font-semibold"
          >
            ↻ New Challenge
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              ...
              value={levels.lv1}
              onChange={(e) => setLevels({...levels, lv1: e.target.value})}
            />
          </div>
          <div>
            ...
            <input 
              ...
              value={levels.lv2}
              onChange={(e) => setLevels({...levels, lv2: e.target.value})}
            />
          </div>
          <div>
            ...
            <input 
              ...
              value={levels.lv3}
              onChange={(e) => setLevels({...levels, lv3: e.target.value})}
            />
          </div>
        </div>
